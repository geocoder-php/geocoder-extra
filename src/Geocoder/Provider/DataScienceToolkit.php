 ...
 */
class DataScienceToolkit extends AbstractHttpProvider implements Geocoder
{
    /**
     * @var string
     */
    ...
    {
        if (empty($address)) {
            throw new UnsupportedOperation('The DataScienceToolkitProvider does not support empty addresses.');
        }

        if (filter_var($address, FILTER_VALIDATE_IP, FILTER_FLAG_IPV6)) {
            throw new UnsupportedOperation('The DataScienceToolkitProvider does not support IPv6 addresses.');
        }
