...
XML;
    ...
    public function testGetGeocodedDataWithRealAddressUS()
    {
        ...
        $result = $result[0];
        $this->assertInternalType('array', $result);
        $this->assertEquals(38.898748, $result['latitude'], '', 0.01);
        $this->assertEquals(-77.037684, $result['longitude'], '', 0.01);
        $this->assertNull($result['bounds']['south']);
        $this->assertNull($result['bounds']['west']);
        $this->assertNull($result['bounds']['north']);
        $this->assertNull($result['bounds']['east']);
